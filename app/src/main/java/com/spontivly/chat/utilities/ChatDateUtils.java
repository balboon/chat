package com.spontivly.chat.utilities;
...
/**
 * Class for handling date conversions that are useful for Spontivly.
 */
public final class ChatDateUtils {
    ...
    /**
     * In order to ensure consistent inserts, we check that dates have been
     ...
     *
     * @return A user-friendly representation of the date and can be customized
     */
