...
public class ChatProvider extends ContentProvider {
    ...
    /*
     * Constants for different URIs for data return
     */
    public static final int CODE_EVENT_CHAT = 100;
    public static final int CODE_EVENT = 101;
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        /* This URI is content://com.spontivly.app/eventChat/ */
        matcher.addURI(authority, ChatContract.PATH_EVENT_CHAT, CODE_EVENT_CHAT);

        /*
         * This URI would look something like content://com.spontivly.app/eventChat/99854
         * The "/#" signifies to the UriMatcher that if PATH_EVENT_CHAT is followed by ANY number,
         * that it should return the CODE_EVENT code
         */
        matcher.addURI(authority, ChatContract.PATH_EVENT_CHAT + "/#", CODE_EVENT);
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case CODE_EVENT: {
                ...
                cursor = mOpenHelper.getReadableDatabase().query(
                        ...
                        ChatContract.EventChatEntry.TABLE_NAME,
                        /*
                         ...
                         */
                        ChatContract.EventChatEntry.COLUMN_EVENT_ID + " = ? ",
                        selectionArguments,
                        null,
                        null,
                        sortOrder);
